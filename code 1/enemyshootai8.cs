...
public class enemyshootai8 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // Fix the rotation along the X-axis, but allow rotation around the Y and Z axes.
        Quaternion fixedRotation = Quaternion.Euler(-90.46f, transform.rotation.eulerAngles.y, transform.rotation.eulerAngles.z);

        // Combine the rotations.
        Quaternion finalRotation = Quaternion.Slerp(transform.rotation, targetRotation * fixedRotation, Time.deltaTime * smoothness);
    ...
    private void Shoot()
    {
        ...
        GameObject projectile = Instantiate(projectilePrefab, spawnPosition, Quaternion.LookRotation(toPlayer));
