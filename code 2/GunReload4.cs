...
public class GunReload4 : MonoBehaviour
{
    public AmmoManager2 ammoManager; // Change to the correct AmmoManager script
    ...
    private IEnumerator ReloadCoroutine(float endRotation)
    {
        ...
        // Call the ReloadGun method in the AmmoManager2 script to handle actual reloading logic
        if (ammoManager != null)
        {
        ...
        {
            Debug.LogWarning("AmmoManager reference is not assigned in GunReload4 script.");
        }
    }
}
